...
import { useAddtoreviewmoviesMutation, useGetOneMovieQuery } from "../../redux/api/MovirapiSlice";
...
const MovieDetails = () => {
    ...
    const { data: movie, refetch } = useGetOneMovieQuery(movieId);


    const [createReview, { isLoading: loadingMovieReview }] =
    useAddtoreviewmoviesMutation();
