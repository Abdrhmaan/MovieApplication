...
import { useCreateMoviesMutation, useUploadImageMutation } from '../../redux/api/MovirapiSlice';
...
const CreatMovies = () => {
  ...
  if(createMovieErrorDetail){
    console.log(createMovieErrorDetail)
  }
  const [
    uploadImage,
  ...
  const { data: genres, isLoading: isLoadingGenres } = useFecthGenraQuery();
