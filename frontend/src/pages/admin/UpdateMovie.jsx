...
import { useDeleteMoviesMutation, useGetOneMovieQuery, useUpdateMoviesMutation, useUploadImageMutation } from '../../redux/api/MovirapiSlice';
...
const UpdateMovie = () => {
  ...
  const { data: initialMovieData } = useGetOneMovieQuery(id);
